...
- **Outcome**: Validation accuracy of 90.56% (see the **Results Overview** for further details)
...
Below is the learning curve and the confusion matrix from the final model:
